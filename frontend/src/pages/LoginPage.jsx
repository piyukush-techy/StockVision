      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-2xl font-black text-white tracking-tight">StockVision</span>
          </Link>
          <p className="text-blue-300/70 text-sm mt-2">Professional NSE stock analysis</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <button onClick={handleGoogle} disabled={busy}
            className="w-full flex items-center justify-center gap-3 bg-white text-slate-800 font-semibold py-3 rounded-xl hover:bg-slate-100 transition-all shadow-lg mb-5 disabled:opacity-50">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={busy}
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 rounded-xl transition-all shadow-lg disabled:opacity-50 mt-2">
